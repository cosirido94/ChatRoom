...
QT_MOC_LITERAL(1, 13, 11), // "messageSent"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 7) // "message"

    },
    "SenderThread\0messageSent\0\0message"
};
...
void SenderThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SenderThread::messageSent)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SenderThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_SenderThread.data,
...
// SIGNAL 0
void SenderThread::messageSent(const QString & _t1)
{
